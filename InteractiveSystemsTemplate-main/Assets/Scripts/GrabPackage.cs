...
public class GrabPackage : MonoBehaviour
{
    ...
    {
        if (other.gameObject.CompareTag("pickpackage") || other.gameObject.CompareTag("shovel")|| other.gameObject.CompareTag("seeds") || other.gameObject.CompareTag("Water") || other.gameObject.CompareTag("corn")|| other.gameObject.CompareTag("carrot")|| other.gameObject.CompareTag("tomato") )
        {
